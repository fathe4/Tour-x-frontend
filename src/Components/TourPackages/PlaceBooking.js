...
const PlaceBooking = () => {
    ...
    const onSubmit = data => {
        ...
        console.log(data);
        fetch(`http://localhost:5000/packages/bookings/`, {
            method: 'POST',
            headers: {
    ...
    return (
        <div className='container w-25 shadow p-4 rounded mt-5'>
            <h3 className='fw-bold py-3 text-center'>Book This Package</h3>
